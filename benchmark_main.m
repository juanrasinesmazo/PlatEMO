...
%                 'maxFE', n_max,  'save', (n_max-n_lhs), 'outputFcn', @ALGORITHM.Output);
        ...
        % Collect Output & Save
        outpath = '/home/juan/PycharmProjects/optimisation_framework/PlatEMO/PlatEMO/Data/KRVEA/';
        savepath = '/home/juan/Documents/Juan/shared_dir/';
        filename = sprintf('KRVEA_%s_M%.0f_D%.0f_%0.f.mat', prob, n_obj, dim, seed+1);
...
%         n_eval = n_lhs:5:n_max;
        ...
        % Save IGD values
        filename = sprintf('%s_krvea_final_maxgen_%.0f_sampling_%0.f_seed_%.0f_igd_metric.txt', lower(prob), n_max, n_lhs, seed);
        ...
        second_filename = sprintf('%s_krvea_final_maxgen_%.0f_sampling_%0.f_seed_%.0f_population.txt', lower(prob), n_max, n_lhs, seed);
